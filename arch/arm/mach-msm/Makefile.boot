...
ifneq ($(CONFIG_MACH_SONY_FALCONSS),y)
        ...
        dtb-$(CONFIG_MACH_SONY_FALCONSS)	+= msm8610-falcon-v1-cdp.dtb
        dtb-$(CONFIG_MACH_SONY_FALCONSS)	+= msm8610-falcon-v2-cdp.dtb
        dtb-$(CONFIG_MACH_SONY_FALCONSS)	+= msm8610-falcon-v1-mtp.dtb
        dtb-$(CONFIG_MACH_SONY_FALCONSS)	+= msm8610-falcon-v2-mtp.dtb
